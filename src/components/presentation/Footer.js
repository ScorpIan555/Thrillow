        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-md-3">
                    <img alt="Image" src="dist/assets/img/play-now.jpg" style={{width:50, height:50}} className="mb-4" />
                    <p className="text-muted">
                        &copy; 2018 Van Daley Industries, LLC

                    </p>
                </div>

                <div className="col-12 col-md-9">
                    <span className="h5">Zillow Brands: </span>
